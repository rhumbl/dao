...
/***/ function(module, exports, __webpack_require__) {
	...
	function getPathway(entityId, relationshipTypes, algorithmName, data) {
	  ...
	  if (algorithmName === 'INCOMING_ALL') {
	    nodes = (0, _getIncomingEntitiesAll2.default)(entityId, relationshipTypes, data);
	  } else if (algorithmName === 'INCOMING') {
	    nodes = (0, _getIncomingEntities2.default)(entityId, relationshipTypes, data);
	  } else if (algorithmName === 'OUTGOING_ALL') {
	    nodes = (0, _getOutgoingEntitiesAll2.default)(entityId, relationshipTypes, data);
	  } else if (algorithmName === 'OUTGOING') {
	    nodes = (0, _getOutgoingEntities2.default)(entityId, relationshipTypes, data);
	    // console.log(nodes);
	  ...
	  nodes = (nodes || []).concat((0, _getEntityById2.default)(entityId, data.entities));
	  var edges = (0, _getEdgeSet2.default)(_lodash2.default.map(nodes, 'id'), relationshipTypes, data);
