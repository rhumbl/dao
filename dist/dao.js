...
/***/ function(module, exports) {
	...
	/******/return __webpack_require__(0);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){__webpack_require__(1);module.exports=__webpack_require__(3);/***/},/* 1 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global){'use strict';Object.defineProperty(exports,"__esModule",{value:true});/* requires and exposes the separate components of the app */var dao=window.dao||{};//dao = require('./src/dao.js');
	dao=__webpack_require__(2);// make dao available globally
	window.dao=dao;global.dao=dao;exports.default=dao;module.exports=dao;/* WEBPACK VAR INJECTION */}).call(exports,function(){return this;}());/***/},/* 2 *//***/function(module,exports){"use strict";var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==="undefined"?"undefined":_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol?"symbol":typeof obj==="undefined"?"undefined":_typeof2(obj);};/******/(function(modules){// webpackBootstrap
	/******/// The module cache
	/******/var installedModules={};/******/// The require function
	/******/function __webpack_require__(moduleId){/******/// Check if module is in cache
	/******/if(installedModules[moduleId])/******/return installedModules[moduleId].exports;/******/// Create a new module (and put it into the cache)
	...
	/******/__webpack_require__.c=installedModules;/******/// __webpack_public_path__
	/******/__webpack_require__.p="";/******/// Load entry module and return exports
	/******/return __webpack_require__(0);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global){'use strict';Object.defineProperty(exports,"__esModule",{value:true});/* requires and exposes the separate components of the app */var dao=window.dao||{};dao=__webpack_require__(1);// make dao available globally
	window.dao=dao;global.dao=dao;exports.default=dao;module.exports=dao;/* WEBPACK VAR INJECTION */}).call(exports,function(){return this;}());/***/},/* 1 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global){'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.rankDAG=exports.getPathway=exports.getEdgeSet=exports.getOutgoingEntitiesAll=exports.getOutgoingEntities=exports.getIncomingEntitiesAll=exports.getIncomingEntities=exports.getEntityById=undefined;var _lodash=__webpack_require__(2);var _lodash2=_interopRequireDefault(_lodash);var _getEntityById=__webpack_require__(4);var _getEntityById2=_interopRequireDefault(_getEntityById);var _getEdgeSet=__webpack_require__(5);var _getEdgeSet2=_interopRequireDefault(_getEdgeSet);var _getIncomingEntities=__webpack_require__(6);var _getIncomingEntities2=_interopRequireDefault(_getIncomingEntities);var _getIncomingEntitiesAll=__webpack_require__(7);var _getIncomingEntitiesAll2=_interopRequireDefault(_getIncomingEntitiesAll);var _getOutgoingEntities=__webpack_require__(8);var _getOutgoingEntities2=_interopRequireDefault(_getOutgoingEntities);var _getOutgoingEntitiesAll=__webpack_require__(9);var _getOutgoingEntitiesAll2=_interopRequireDefault(_getOutgoingEntitiesAll);var _getPathway=__webpack_require__(10);var _getPathway2=_interopRequireDefault(_getPathway);var _rankDAG=__webpack_require__(11);var _rankDAG2=_interopRequireDefault(_rankDAG);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var dao=window.dao||{};window.dao=dao;global.dao=dao;exports.getEntityById=_getEntityById2.default;exports.getIncomingEntities=_getIncomingEntities2.default;exports.getIncomingEntitiesAll=_getIncomingEntitiesAll2.default;exports.getOutgoingEntities=_getOutgoingEntities2.default;exports.getOutgoingEntitiesAll=_getOutgoingEntitiesAll2.default;exports.getEdgeSet=_getEdgeSet2.default;exports.getPathway=_getPathway2.default;exports.rankDAG=_rankDAG2.default;/* WEBPACK VAR INJECTION */}).call(exports,function(){return this;}());/***/},/* 2 *//***/function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module,global){/**
			 * @license
	...
	if(enumerate&&!propertyIsEnumerable.call({'valueOf':1},'valueOf')){baseKeysIn=function baseKeysIn(object){return iteratorToArray(enumerate(object));};}/**
			     ...
			     * @param {Object} [stack] Tracks traversed source values and their merged counterparts.
			     */function baseMergeDeep(object,source,key,srcIndex,mergeFunc,customizer,stack){var objValue=object[key],srcValue=source[key],stacked=stack.get(srcValue)||stack.get(objValue);if(stacked){assignMergeValue(object,key,stacked);return;}var newValue=customizer?customizer(objValue,srcValue,key+'',object,source,stack):undefined,isCommon=newValue===undefined;if(isCommon){newValue=srcValue;if(isArray(srcValue)||isTypedArray(srcValue)){if(isArray(objValue)){newValue=srcIndex?copyArray(objValue):objValue;}else if(isArrayLikeObject(objValue)){newValue=copyArray(objValue);}else{newValue=baseClone(srcValue);}}else if(isPlainObject(srcValue)||isArguments(srcValue)){if(isArguments(objValue)){newValue=toPlainObject(objValue);}else if(!isObject(objValue)||srcIndex&&isFunction(objValue)){newValue=baseClone(srcValue);}else{newValue=srcIndex?baseClone(objValue):objValue;}}else{isCommon=false;}}stack.set(srcValue,newValue);if(isCommon){// Recursively merge objects and arrays (susceptible to call stack limits).
	...
	root._=_;}}).call(this);/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(3)(module),function(){return this;}());/***/},/* 3 *//***/function(module,exports){module.exports=function(module){if(!module.webpackPolyfill){module.deprecate=function(){};module.paths=[];// module.parent = undefined by default
	module.children=[];module.webpackPolyfill=1;}return module;};/***/},/* 4 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(2);var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getEntityById(entityId,entities){var fnName='getEntityById';var result=_lodash2.default.find(entities,{id:entityId});return result;}exports.default=getEntityById;/***/},/* 5 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(2);var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/** getEdgeSet: returns the edges that are between the given set of nodes
			*/function getEdgeSet(entityIds,relationshipTypes,data){return _lodash2.default.filter(data.relationships,function(r){// let matches = (r.targetId === entityId || r.sourceId === entityId);
	// return relationshipTypes.indexOf(r.type) > -1 && matches;
	var matchesDirection1=entityIds.indexOf(r.targetId)>-1&&entityIds.indexOf(r.sourceId)>-1;var matchesDirection2=entityIds.indexOf(r.sourceId)>-1&&entityIds.indexOf(r.targetId)>-1;return relationshipTypes.indexOf(r.type)>-1&&(matchesDirection1||matchesDirection2);});}exports.default=getEdgeSet;/***/},/* 6 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(2);var _lodash2=_interopRequireDefault(_lodash);var _getEntityById=__webpack_require__(4);var _getEntityById2=_interopRequireDefault(_getEntityById);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getIncomingEntities(entityId,relationshipTypes,data){var fnName='getIncomingEntities';var results=_lodash2.default.uniq(_lodash2.default.compact(_lodash2.default.map(data.relationships,function(r){if(relationshipTypes.indexOf(r.type)>-1&&r.targetId===entityId){return(0,_getEntityById2.default)(r.sourceId,data.entities);}})));return results;}exports.default=getIncomingEntities;/***/},/* 7 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(2);var _lodash2=_interopRequireDefault(_lodash);var _getIncomingEntities=__webpack_require__(6);var _getIncomingEntities2=_interopRequireDefault(_getIncomingEntities);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getIncomingEntitiesAll(entityId,relationshipTypes,data){var fnName='getIncomingEntitiesAll';if(!data){console.error(fnName,'data not provided.');};var results=[];var haveChecked=[];var traverse=function traverse(itemId){var ps=(0,_getIncomingEntities2.default)(itemId,relationshipTypes,data);results=results.concat(ps);for(var i=0;i<ps.length;i++){var p=ps[i];if(haveChecked.indexOf(p)===-1){haveChecked.push(p);traverse.bind(this)(p.id);}}}.bind(this);traverse(entityId);return _lodash2.default.uniq(results);}exports.default=getIncomingEntitiesAll;/***/},/* 8 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(2);var _lodash2=_interopRequireDefault(_lodash);var _getEntityById=__webpack_require__(4);var _getEntityById2=_interopRequireDefault(_getEntityById);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getOutgoingEntities(entityId,relationshipTypes,data){var fnName='getOutgoingEntities';var results=_lodash2.default.uniq(_lodash2.default.compact(_lodash2.default.map(data.relationships,function(e){if(relationshipTypes.indexOf(e.type,data)>-1&&e.sourceId==entityId)return(0,_getEntityById2.default)(e.targetId,data.entities);},this)));return results;}exports.default=getOutgoingEntities;/***/},/* 9 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(2);var _lodash2=_interopRequireDefault(_lodash);var _getOutgoingEntities=__webpack_require__(8);var _getOutgoingEntities2=_interopRequireDefault(_getOutgoingEntities);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getOutgoingEntitiesAll(entityId,relationshipTypes,data){var fnName='getOutgoingEntitiesAll';if(!data){console.error(fnName,'data not provided.');};var results=[];var haveChecked=[];var traverse=function traverse(itemId){var ps=(0,_getOutgoingEntities2.default)(itemId,relationshipTypes,data);results=results.concat(ps);for(var i=0;i<ps.length;i++){var p=ps[i];if(haveChecked.indexOf(p)===-1){haveChecked.push(p);traverse.bind(this)(p.id);}}}.bind(this);traverse(entityId);return _lodash2.default.uniq(results);}exports.default=getOutgoingEntitiesAll;/***/},/* 10 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(2);var _lodash2=_interopRequireDefault(_lodash);var _getIncomingEntitiesAll=__webpack_require__(7);var _getIncomingEntitiesAll2=_interopRequireDefault(_getIncomingEntitiesAll);var _getIncomingEntities=__webpack_require__(6);var _getIncomingEntities2=_interopRequireDefault(_getIncomingEntities);var _getOutgoingEntitiesAll=__webpack_require__(9);var _getOutgoingEntitiesAll2=_interopRequireDefault(_getOutgoingEntitiesAll);var _getOutgoingEntities=__webpack_require__(8);var _getOutgoingEntities2=_interopRequireDefault(_getOutgoingEntities);var _getEdgeSet=__webpack_require__(5);var _getEdgeSet2=_interopRequireDefault(_getEdgeSet);var _getEntityById=__webpack_require__(4);var _getEntityById2=_interopRequireDefault(_getEntityById);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getPathway(entityId,relationshipTypes,algorithmName,data){var nodes=[];if(!relationshipTypes||relationshipTypes.length===0){console.error('getPathway: relationshipTypes[] cannot be null');}if(algorithmName==='INCOMING_ALL'){nodes=(0,_getIncomingEntitiesAll2.default)(entityId,relationshipTypes,data);}else if(algorithmName==='INCOMING'){nodes=(0,_getIncomingEntities2.default)(entityId,relationshipTypes,data);}else if(algorithmName==='OUTGOING_ALL'){nodes=(0,_getOutgoingEntitiesAll2.default)(entityId,relationshipTypes,data);}else if(algorithmName==='OUTGOING'){nodes=(0,_getOutgoingEntities2.default)(entityId,relationshipTypes,data);// console.log(nodes);
	}else if(algorithmName==='INCOMING-OUTGOING'){var nodesIncoming=(0,_getIncomingEntities2.default)(entityId,relationshipTypes,data);var nodesOutgoing=(0,_getOutgoingEntities2.default)(entityId,relationshipTypes,data);nodes=nodesIncoming.concat(nodesOutgoing);}else{console.error('algorithmName',algorithmName,'not recognized');}nodes=(nodes||[]).concat((0,_getEntityById2.default)(entityId,data.entities));var edges=(0,_getEdgeSet2.default)(_lodash2.default.map(nodes,'id'),relationshipTypes,data);return{nodes:nodes,edges:edges};}exports.default=getPathway;/***/},/* 11 *//***/function(module,exports){'use strict';Object.defineProperty(exports,"__esModule",{value:true});/** rankDAG: constructs the ranking of each node in the given Directed Acyclic Graph
			*/function rankDAG(dag,iterateeFn){var maxIterations=arguments.length<=2||arguments[2]===undefined?10:arguments[2];if(!dag){console.error('DAG of {nodes: [], edges:[]} must be given');}var nodes=dag.nodes;var findDepthTraverse=function findDepthTraverse(arg,iterateeFn,iterations){iterations++;var quantity=iterateeFn(arg);if(quantity.length==0){return 0;}else if(iterations>maxIterations){console.warn('There may be a cycle:',arg.name);return 0;}else{var maxDepth=0;for(var i=quantity.length;i--;){maxDepth=Math.max(maxDepth,findDepthTraverse(quantity[i],iterateeFn,iterations));}return maxDepth+1;}};var levels={};for(var j=0;j<nodes.length;j++){var iterations=0;var depth=findDepthTraverse(nodes[j],iterateeFn,iterations);levels[depth]=levels[depth]||[];levels[depth].push(nodes[j]);}return levels;}exports.default=rankDAG;/***/}/******/]);/***/},/* 3 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global){'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.rankDAG=exports.getPathway=exports.getEdgeSet=exports.getOutgoingEntitiesAll=exports.getOutgoingEntities=exports.getIncomingEntitiesAll=exports.getIncomingEntities=exports.getEntityById=undefined;var _lodash=__webpack_require__(4);var _lodash2=_interopRequireDefault(_lodash);var _getEntityById=__webpack_require__(6);var _getEntityById2=_interopRequireDefault(_getEntityById);var _getEdgeSet=__webpack_require__(7);var _getEdgeSet2=_interopRequireDefault(_getEdgeSet);var _getIncomingEntities=__webpack_require__(8);var _getIncomingEntities2=_interopRequireDefault(_getIncomingEntities);var _getIncomingEntitiesAll=__webpack_require__(9);var _getIncomingEntitiesAll2=_interopRequireDefault(_getIncomingEntitiesAll);var _getOutgoingEntities=__webpack_require__(10);var _getOutgoingEntities2=_interopRequireDefault(_getOutgoingEntities);var _getOutgoingEntitiesAll=__webpack_require__(11);var _getOutgoingEntitiesAll2=_interopRequireDefault(_getOutgoingEntitiesAll);var _getPathway=__webpack_require__(12);var _getPathway2=_interopRequireDefault(_getPathway);var _rankDAG=__webpack_require__(13);var _rankDAG2=_interopRequireDefault(_rankDAG);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var dao=window.dao||{};window.dao=dao;global.dao=dao;exports.getEntityById=_getEntityById2.default;exports.getIncomingEntities=_getIncomingEntities2.default;exports.getIncomingEntitiesAll=_getIncomingEntitiesAll2.default;exports.getOutgoingEntities=_getOutgoingEntities2.default;exports.getOutgoingEntitiesAll=_getOutgoingEntitiesAll2.default;exports.getEdgeSet=_getEdgeSet2.default;exports.getPathway=_getPathway2.default;exports.rankDAG=_rankDAG2.default;/* WEBPACK VAR INJECTION */}).call(exports,function(){return this;}());/***/},/* 4 *//***/function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module,global){/**
		 * @license
		 * lodash 4.0.1 (Custom Build) <https://lodash.com/>
		 * Build: `lodash -d -o ./lodash.js`
		 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
		 ...
		 */;(function(){/** Used as a safe reference for `undefined` in pre-ES5 environments. */var undefined;/** Used as the semantic version number. */var VERSION='4.0.1';/** Used to compose bitmasks for wrapper metadata. */var BIND_FLAG=1,BIND_KEY_FLAG=2,CURRY_BOUND_FLAG=4,CURRY_FLAG=8,CURRY_RIGHT_FLAG=16,PARTIAL_FLAG=32,PARTIAL_RIGHT_FLAG=64,ARY_FLAG=128,REARG_FLAG=256,FLIP_FLAG=512;/** Used to compose bitmasks for comparison styles. */var UNORDERED_COMPARE_FLAG=1,PARTIAL_COMPARE_FLAG=2;/** Used as default options for `_.truncate`. */var DEFAULT_TRUNC_LENGTH=30,DEFAULT_TRUNC_OMISSION='...';/** Used to detect hot functions by number of calls within a span of milliseconds. */var HOT_COUNT=150,HOT_SPAN=16;/** Used as the size to enable large array optimizations. */var LARGE_ARRAY_SIZE=200;/** Used to indicate the type of lazy iteratees. */var LAZY_FILTER_FLAG=1,LAZY_MAP_FLAG=2,LAZY_WHILE_FLAG=3;/** Used as the `TypeError` message for "Functions" methods. */var FUNC_ERROR_TEXT='Expected a function';/** Used to stand-in for `undefined` hash values. */var HASH_UNDEFINED='__lodash_hash_undefined__';/** Used as references for various `Number` constants. */var INFINITY=1/0,MAX_SAFE_INTEGER=9007199254740991,MAX_INTEGER=1.7976931348623157e+308,NAN=0/0;/** Used as references for the maximum length and index of an array. */var MAX_ARRAY_LENGTH=4294967295,MAX_ARRAY_INDEX=MAX_ARRAY_LENGTH-1,HALF_MAX_ARRAY_LENGTH=MAX_ARRAY_LENGTH>>>1;/** Used as the internal argument placeholder. */var PLACEHOLDER='__lodash_placeholder__';/** `Object#toString` result references. */var argsTag='[object Arguments]',arrayTag='[object Array]',boolTag='[object Boolean]',dateTag='[object Date]',errorTag='[object Error]',funcTag='[object Function]',genTag='[object GeneratorFunction]',mapTag='[object Map]',numberTag='[object Number]',objectTag='[object Object]',regexpTag='[object RegExp]',setTag='[object Set]',stringTag='[object String]',symbolTag='[object Symbol]',weakMapTag='[object WeakMap]';var arrayBufferTag='[object ArrayBuffer]',float32Tag='[object Float32Array]',float64Tag='[object Float64Array]',int8Tag='[object Int8Array]',int16Tag='[object Int16Array]',int32Tag='[object Int32Array]',uint8Tag='[object Uint8Array]',uint8ClampedTag='[object Uint8ClampedArray]',uint16Tag='[object Uint16Array]',uint32Tag='[object Uint32Array]';/** Used to match empty string literals in compiled template source. */var reEmptyStringLeading=/\b__p \+= '';/g,reEmptyStringMiddle=/\b(__p \+=) '' \+/g,reEmptyStringTrailing=/(__e\(.*?\)|\b__t\)) \+\n'';/g;/** Used to match HTML entities and HTML characters. */var reEscapedHtml=/&(?:amp|lt|gt|quot|#39|#96);/g,reUnescapedHtml=/[&<>"'`]/g,reHasEscapedHtml=RegExp(reEscapedHtml.source),reHasUnescapedHtml=RegExp(reUnescapedHtml.source);/** Used to match template delimiters. */var reEscape=/<%-([\s\S]+?)%>/g,reEvaluate=/<%([\s\S]+?)%>/g,reInterpolate=/<%=([\s\S]+?)%>/g;/** Used to match property names within property paths. */var reIsDeepProp=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,reIsPlainProp=/^\w*$/,rePropName=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]/g;/** Used to match `RegExp` [syntax characters](http://ecma-international.org/ecma-262/6.0/#sec-patterns). */var reRegExpChar=/[\\^$.*+?()[\]{}|]/g,reHasRegExpChar=RegExp(reRegExpChar.source);/** Used to match leading and trailing whitespace. */var reTrim=/^\s+|\s+$/g,reTrimStart=/^\s+/,reTrimEnd=/\s+$/;/** Used to match backslashes in property paths. */var reEscapeChar=/\\(\\)?/g;/** Used to match [ES template delimiters](http://ecma-international.org/ecma-262/6.0/#sec-template-literal-lexical-components). */var reEsTemplate=/\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g;/** Used to match `RegExp` flags from their coerced string values. */var reFlags=/\w*$/;/** Used to detect hexadecimal string values. */var reHasHexPrefix=/^0x/i;/** Used to detect bad signed hexadecimal string values. */var reIsBadHex=/^[-+]0x[0-9a-f]+$/i;/** Used to detect binary string values. */var reIsBinary=/^0b[01]+$/i;/** Used to detect host constructors (Safari > 5). */var reIsHostCtor=/^\[object .+?Constructor\]$/;/** Used to detect octal string values. */var reIsOctal=/^0o[0-7]+$/i;/** Used to detect unsigned integer values. */var reIsUint=/^(?:0|[1-9]\d*)$/;/** Used to match latin-1 supplementary letters (excluding mathematical operators). */var reLatin1=/[\xc0-\xd6\xd8-\xde\xdf-\xf6\xf8-\xff]/g;/** Used to ensure capturing order of template delimiters. */var reNoMatch=/($^)/;/** Used to match unescaped characters in compiled string literals. */var reUnescapedString=/['\n\r\u2028\u2029\\]/g;/** Used to compose unicode character classes. */var rsAstralRange="\\ud800-\\udfff",rsComboMarksRange="\\u0300-\\u036f\\ufe20-\\ufe23",rsComboSymbolsRange="\\u20d0-\\u20f0",rsDingbatRange="\\u2700-\\u27bf",rsLowerRange='a-z\\xdf-\\xf6\\xf8-\\xff',rsMathOpRange='\\xac\\xb1\\xd7\\xf7',rsNonCharRange='\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf',rsQuoteRange="\\u2018\\u2019\\u201c\\u201d",rsSpaceRange=" \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",rsUpperRange='A-Z\\xc0-\\xd6\\xd8-\\xde',rsVarRange="\\ufe0e\\ufe0f",rsBreakRange=rsMathOpRange+rsNonCharRange+rsQuoteRange+rsSpaceRange;/** Used to compose unicode capture groups. */var rsAstral='['+rsAstralRange+']',rsBreak='['+rsBreakRange+']',rsCombo='['+rsComboMarksRange+rsComboSymbolsRange+']',rsDigits='\\d+',rsDingbat='['+rsDingbatRange+']',rsLower='['+rsLowerRange+']',rsMisc='[^'+rsAstralRange+rsBreakRange+rsDigits+rsDingbatRange+rsLowerRange+rsUpperRange+']',rsFitz="\\ud83c[\\udffb-\\udfff]",rsModifier='(?:'+rsCombo+'|'+rsFitz+')',rsNonAstral='[^'+rsAstralRange+']',rsRegional="(?:\\ud83c[\\udde6-\\uddff]){2}",rsSurrPair="[\\ud800-\\udbff][\\udc00-\\udfff]",rsUpper='['+rsUpperRange+']',rsZWJ="\\u200d";/** Used to compose unicode regexes. */var rsLowerMisc='(?:'+rsLower+'|'+rsMisc+')',rsUpperMisc='(?:'+rsUpper+'|'+rsMisc+')',reOptMod=rsModifier+'?',rsOptVar='['+rsVarRange+']?',rsOptJoin='(?:'+rsZWJ+'(?:'+[rsNonAstral,rsRegional,rsSurrPair].join('|')+')'+rsOptVar+reOptMod+')*',rsSeq=rsOptVar+reOptMod+rsOptJoin,rsEmoji='(?:'+[rsDingbat,rsRegional,rsSurrPair].join('|')+')'+rsSeq,rsSymbol='(?:'+[rsNonAstral+rsCombo+'?',rsCombo,rsRegional,rsSurrPair,rsAstral].join('|')+')';/**
		   * Used to match [combining diacritical marks](https://en.wikipedia.org/wiki/Combining_Diacritical_Marks) and
		   * [combining diacritical marks for symbols](https://en.wikipedia.org/wiki/Combining_Diacritical_Marks_for_Symbols).
		   */var reComboMark=RegExp(rsCombo,'g');/** Used to match [string symbols](https://mathiasbynens.be/notes/javascript-unicode). */var reComplexSymbol=RegExp(rsFitz+'(?='+rsFitz+')|'+rsSymbol+rsSeq,'g');/** Used to detect strings with [zero-width joiners or code points from the astral planes](http://eev.ee/blog/2015/09/12/dark-corners-of-unicode/). */var reHasComplexSymbol=RegExp('['+rsZWJ+rsAstralRange+rsComboMarksRange+rsComboSymbolsRange+rsVarRange+']');/** Used to match non-compound words composed of alphanumeric characters. */var reBasicWord=/[a-zA-Z0-9]+/g;/** Used to match complex or compound words. */var reComplexWord=RegExp([rsUpper+'?'+rsLower+'+(?='+[rsBreak,rsUpper,'$'].join('|')+')',rsUpperMisc+'+(?='+[rsBreak,rsUpper+rsLowerMisc,'$'].join('|')+')',rsUpper+'?'+rsLowerMisc+'+',rsUpper+'+',rsDigits,rsEmoji].join('|'),'g');/** Used to detect strings that need a more robust regexp to match words. */var reHasComplexWord=/[a-z][A-Z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;/** Used to assign default `context` object properties. */var contextProps=['Array','Date','Error','Float32Array','Float64Array','Function','Int8Array','Int16Array','Int32Array','Map','Math','Object','Reflect','RegExp','Set','String','Symbol','TypeError','Uint8Array','Uint8ClampedArray','Uint16Array','Uint32Array','WeakMap','_','clearTimeout','isFinite','parseInt','setTimeout'];/** Used to make template sourceURLs easier to identify. */var templateCounter=-1;/** Used to identify `toStringTag` values of typed arrays. */var typedArrayTags={};typedArrayTags[float32Tag]=typedArrayTags[float64Tag]=typedArrayTags[int8Tag]=typedArrayTags[int16Tag]=typedArrayTags[int32Tag]=typedArrayTags[uint8Tag]=typedArrayTags[uint8ClampedTag]=typedArrayTags[uint16Tag]=typedArrayTags[uint32Tag]=true;typedArrayTags[argsTag]=typedArrayTags[arrayTag]=typedArrayTags[arrayBufferTag]=typedArrayTags[boolTag]=typedArrayTags[dateTag]=typedArrayTags[errorTag]=typedArrayTags[funcTag]=typedArrayTags[mapTag]=typedArrayTags[numberTag]=typedArrayTags[objectTag]=typedArrayTags[regexpTag]=typedArrayTags[setTag]=typedArrayTags[stringTag]=typedArrayTags[weakMapTag]=false;/** Used to identify `toStringTag` values supported by `_.clone`. */var cloneableTags={};cloneableTags[argsTag]=cloneableTags[arrayTag]=cloneableTags[arrayBufferTag]=cloneableTags[boolTag]=cloneableTags[dateTag]=cloneableTags[float32Tag]=cloneableTags[float64Tag]=cloneableTags[int8Tag]=cloneableTags[int16Tag]=cloneableTags[int32Tag]=cloneableTags[mapTag]=cloneableTags[numberTag]=cloneableTags[objectTag]=cloneableTags[regexpTag]=cloneableTags[setTag]=cloneableTags[stringTag]=cloneableTags[symbolTag]=cloneableTags[uint8Tag]=cloneableTags[uint8ClampedTag]=cloneableTags[uint16Tag]=cloneableTags[uint32Tag]=true;cloneableTags[errorTag]=cloneableTags[funcTag]=cloneableTags[weakMapTag]=false;/** Used to map latin-1 supplementary letters to basic latin letters. */var deburredLetters={'\xc0':'A','\xc1':'A','\xc2':'A','\xc3':'A','\xc4':'A','\xc5':'A','\xe0':'a','\xe1':'a','\xe2':'a','\xe3':'a','\xe4':'a','\xe5':'a','\xc7':'C','\xe7':'c','\xd0':'D','\xf0':'d','\xc8':'E','\xc9':'E','\xca':'E','\xcb':'E','\xe8':'e','\xe9':'e','\xea':'e','\xeb':'e','\xcC':'I','\xcd':'I','\xce':'I','\xcf':'I','\xeC':'i','\xed':'i','\xee':'i','\xef':'i','\xd1':'N','\xf1':'n','\xd2':'O','\xd3':'O','\xd4':'O','\xd5':'O','\xd6':'O','\xd8':'O','\xf2':'o','\xf3':'o','\xf4':'o','\xf5':'o','\xf6':'o','\xf8':'o','\xd9':'U','\xda':'U','\xdb':'U','\xdc':'U','\xf9':'u','\xfa':'u','\xfb':'u','\xfc':'u','\xdd':'Y','\xfd':'y','\xff':'y','\xc6':'Ae','\xe6':'ae','\xde':'Th','\xfe':'th','\xdf':'ss'};/** Used to map characters to HTML entities. */var htmlEscapes={'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;','`':'&#96;'};/** Used to map HTML entities to characters. */var htmlUnescapes={'&amp;':'&','&lt;':'<','&gt;':'>','&quot;':'"','&#39;':"'",'&#96;':'`'};/** Used to determine if values are of the language type `Object`. */var objectTypes={'function':true,'object':true};/** Used to escape characters for inclusion in compiled string literals. */var stringEscapes={'\\':'\\',"'":"'",'\n':'n','\r':'r',"\u2028":'u2028',"\u2029":'u2029'};/** Built-in method references without a dependency on `root`. */var freeParseFloat=parseFloat,freeParseInt=parseInt;/** Detect free variable `exports`. */var freeExports=objectTypes[typeof exports==="undefined"?"undefined":_typeof2(exports)]&&exports&&!exports.nodeType?exports:null;/** Detect free variable `module`. */var freeModule=objectTypes[typeof module==="undefined"?"undefined":_typeof2(module)]&&module&&!module.nodeType?module:null;/** Detect free variable `global` from Node.js. */var freeGlobal=checkGlobal(freeExports&&freeModule&&(typeof global==="undefined"?"undefined":_typeof2(global))=='object'&&global);/** Detect free variable `self`. */var freeSelf=checkGlobal(objectTypes[typeof self==="undefined"?"undefined":_typeof2(self)]&&self);/** Detect free variable `window`. */var freeWindow=checkGlobal(objectTypes[typeof window==="undefined"?"undefined":_typeof2(window)]&&window);/** Detect the popular CommonJS extension `module.exports`. */var moduleExports=freeModule&&freeModule.exports===freeExports?freeExports:null;/** Detect `this` as the global object. */var thisGlobal=checkGlobal(objectTypes[_typeof2(this)]&&this);/**
		   * Used as a reference to the global object.
		   *
		   * The `this` value is used if it's the global object to avoid Greasemonkey's
		   * restricted `window` object, otherwise the `window` object is used.
	...
	var result=false;if(value!=null&&typeof value.toString!='function'){try{result=!!(value+'');}catch(e){}}return result;}/**
		   ...
		   */function runInContext(context){context=context?_.defaults({},context,_.pick(root,contextProps)):root;/** Built-in constructor references. */var Date=context.Date,Error=context.Error,Math=context.Math,RegExp=context.RegExp,TypeError=context.TypeError;/** Used for built-in method references. */var arrayProto=context.Array.prototype,objectProto=context.Object.prototype;/** Used to resolve the decompiled source of functions. */var funcToString=context.Function.prototype.toString;/** Used to check objects for own properties. */var hasOwnProperty=objectProto.hasOwnProperty;/** Used to generate unique IDs. */var idCounter=0;/** Used to infer the `Object` constructor. */var objectCtorString=funcToString.call(Object);/**
		     * Used to resolve the [`toStringTag`](http://ecma-international.org/ecma-262/6.0/#sec-object.prototype.tostring)
		     * of values.
		     */var objectToString=objectProto.toString;/** Used to restore the original `_` reference in `_.noConflict`. */var oldDash=root._;/** Used to detect if a method is native. */var reIsNative=RegExp('^'+funcToString.call(hasOwnProperty).replace(reRegExpChar,'\\$&').replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,'$1.*?')+'$');/** Built-in value references. */var Reflect=context.Reflect,_Symbol2=context.Symbol,Uint8Array=context.Uint8Array,clearTimeout=context.clearTimeout,enumerate=Reflect?Reflect.enumerate:undefined,getPrototypeOf=Object.getPrototypeOf,getOwnPropertySymbols=Object.getOwnPropertySymbols,iteratorSymbol=_typeof2(iteratorSymbol=_Symbol2&&_Symbol2.iterator)=='symbol'?iteratorSymbol:undefined,propertyIsEnumerable=objectProto.propertyIsEnumerable,setTimeout=context.setTimeout,splice=arrayProto.splice;/* Built-in method references for those with the same name as other `lodash` methods. */var nativeCeil=Math.ceil,nativeFloor=Math.floor,nativeIsFinite=context.isFinite,nativeJoin=arrayProto.join,nativeKeys=Object.keys,nativeMax=Math.max,nativeMin=Math.min,nativeParseInt=context.parseInt,nativeRandom=Math.random,nativeReverse=arrayProto.reverse;/* Built-in method references that are verified to be native. */var Map=getNative(context,'Map'),Set=getNative(context,'Set'),WeakMap=getNative(context,'WeakMap'),nativeCreate=getNative(Object,'create');/** Used to store function metadata. */var metaMap=WeakMap&&new WeakMap();/** Used to detect maps and sets. */var mapCtorString=Map?funcToString.call(Map):'',setCtorString=Set?funcToString.call(Set):'';/** Used to convert symbols to primitives and strings. */var symbolProto=_Symbol2?_Symbol2.prototype:undefined,symbolValueOf=_Symbol2?symbolProto.valueOf:undefined,symbolToString=_Symbol2?symbolProto.toString:undefined;/** Used to lookup unminified function names. */var realNames={};/*------------------------------------------------------------------------*//**
		     * Creates a `lodash` object which wraps `value` to enable implicit method
		     * chaining. Methods that operate on and return arrays, collections, and
		     * functions can be chained together. Methods that retrieve a single value or
		     * may return a primitive value will automatically end the chain sequence and
	...
	// that are composed entirely of index properties, return `false` for
	// `hasOwnProperty` checks of them.
	return hasOwnProperty.call(object,key)||(typeof object==="undefined"?"undefined":_typeof2(object))=='object'&&key in object&&getPrototypeOf(object)===null;}/**
		     * The base implementation of `_.hasIn` without support for deep paths.
		     *
		     * @private
		     * @param {Object} object The object to query.
		     ...
		     * @param {*} [value=_.identity] The value to convert to an iteratee.
		     * @returns {Function} Returns the iteratee.
		     */function baseIteratee(value){var type=typeof value==="undefined"?"undefined":_typeof2(value);if(type=='function'){return value;}if(value==null){return identity;}if(type=='object'){return isArray(value)?baseMatchesProperty(value[0],value[1]):baseMatches(value);}return property(value);}/**
		     * The base implementation of `_.keys` which doesn't skip the constructor
		     * property of prototypes or treat sparse arrays as dense.
		     *
		     * @private
	...
	mergeFunc(newValue,srcValue,srcIndex,customizer,stack);}assignMergeValue(object,key,newValue);}/**
		     ...
		     * @param {Object} symbol The symbol object to clone.
		     * @returns {Object} Returns the cloned symbol object.
		     */function cloneSymbol(symbol){return _Symbol2?Object(symbolValueOf.call(symbol)):{};}/**
		     * Creates a clone of `typedArray`.
		     *
		     * @private
		     * @param {Object} typedArray The typed array to clone.
	...
	// objects as equal. See https://es5.github.io/#x15.10.6.4 for more details.
	return object==other+'';case mapTag:var convert=mapToArray;case setTag:var isPartial=bitmask&PARTIAL_COMPARE_FLAG;convert||(convert=setToArray);// Recursively compare objects (susceptible to call stack limits).
	return(isPartial||object.size==other.size)&&equalFunc(convert(object),convert(other),customizer,bitmask|UNORDERED_COMPARE_FLAG);case symbolTag:return!!_Symbol2&&symbolValueOf.call(object)==symbolValueOf.call(other);}return false;}/**
		     * A specialized version of `baseIsEqualDeep` for objects with support for
		     * partial deep comparisons.
		     *
		     * @private
	...
	if(length&&typeof array[0]=='string'&&hasOwnProperty.call(array,'index')){result.index=array.index;result.input=array.input;}return result;}/**
		     ...
		     * @param {*} value The value to check.
		     * @returns {boolean} Returns `true` if `value` is suitable, else `false`.
		     */function isKeyable(value){var type=typeof value==="undefined"?"undefined":_typeof2(value);return type=='number'||type=='boolean'||type=='string'&&value!=='__proto__'||value==null;}/**
		     * Checks if `func` has a lazy counterpart.
		     *
		     * @private
		     * @param {Function} func The function to check.
	...
	var tag=isObject(value)?objectToString.call(value):'';return tag==funcTag||tag==genTag;}/**
		     ...
		     */function isObject(value){// Avoid a V8 JIT bug in Chrome 19-20.
	// See https://code.google.com/p/v8/issues/detail?id=2291 for more details.
	var type=typeof value==="undefined"?"undefined":_typeof2(value);return!!value&&(type=='object'||type=='function');}/**
		     * Checks if `value` is object-like. A value is object-like if it's not `null`
		     * and has a `typeof` result of "object".
		     *
		     * @static
		     ...
		     * _.isObjectLike(null);
		     * // => false
		     */function isObjectLike(value){return!!value&&(typeof value==="undefined"?"undefined":_typeof2(value))=='object';}/**
		     * Performs a deep comparison between `object` and `source` to determine if
		     * `object` contains equivalent property values.
		     *
		     * **Note:** This method supports comparing the same values as `_.isEqual`.
	...
	return isNumber(value)&&value!=+value;}/**
		     ...
		     * // => '1,2,3'
		     */function toString(value){// Exit early for strings to avoid a performance hit in some environments.
	if(typeof value=='string'){return value;}if(value==null){return'';}if(isSymbol(value)){return _Symbol2?symbolToString.call(value):'';}var result=value+'';return result=='0'&&1/value==-INFINITY?'-0':result;}/*------------------------------------------------------------------------*//**
		     * Assigns own enumerable properties of source objects to the destination
		     * object. Source objects are applied from left to right. Subsequent sources
		     * overwrite property assignments of previous sources.
		     *
	...
	if(moduleExports){(freeModule.exports=_)._=_;}// Export for CommonJS support.
	freeExports._=_;}else{// Export to the global object.
	root._=_;}}).call(this);/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(5)(module),function(){return this;}());/***/},/* 5 *//***/function(module,exports){module.exports=function(module){if(!module.webpackPolyfill){module.deprecate=function(){};module.paths=[];// module.parent = undefined by default
	module.children=[];module.webpackPolyfill=1;}return module;};/***/},/* 6 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(4);var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getEntityById(entityId,entities){var fnName='getEntityById';var result=_lodash2.default.find(entities,{id:entityId});return result;}exports.default=getEntityById;/***/},/* 7 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(4);var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/** getEdgeSet: returns the edges that are between the given set of nodes
		*/function getEdgeSet(entityIds,relationshipTypes,data){return _lodash2.default.filter(data.relationships,function(r){// let matches = (r.targetId === entityId || r.sourceId === entityId);
	// return relationshipTypes.indexOf(r.type) > -1 && matches;
	var matchesDirection1=entityIds.indexOf(r.targetId)>-1&&entityIds.indexOf(r.sourceId)>-1;var matchesDirection2=entityIds.indexOf(r.sourceId)>-1&&entityIds.indexOf(r.targetId)>-1;return relationshipTypes.indexOf(r.type)>-1&&(matchesDirection1||matchesDirection2);});}exports.default=getEdgeSet;/***/},/* 8 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(4);var _lodash2=_interopRequireDefault(_lodash);var _getEntityById=__webpack_require__(6);var _getEntityById2=_interopRequireDefault(_getEntityById);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getIncomingEntities(entityId,relationshipTypes,data){var fnName='getIncomingEntities';var results=_lodash2.default.uniq(_lodash2.default.compact(_lodash2.default.map(data.relationships,function(r){if(relationshipTypes.indexOf(r.type)>-1&&r.targetId===entityId){return(0,_getEntityById2.default)(r.sourceId,data.entities);}})));return results;}exports.default=getIncomingEntities;/***/},/* 9 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(4);var _lodash2=_interopRequireDefault(_lodash);var _getIncomingEntities=__webpack_require__(8);var _getIncomingEntities2=_interopRequireDefault(_getIncomingEntities);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getIncomingEntitiesAll(entityId,relationshipTypes,data){var fnName='getIncomingEntitiesAll';if(!data){console.error(fnName,'data not provided.');};var results=[];var haveChecked=[];var traverse=function traverse(itemId){var ps=(0,_getIncomingEntities2.default)(itemId,relationshipTypes,data);results=results.concat(ps);for(var i=0;i<ps.length;i++){var p=ps[i];if(haveChecked.indexOf(p)===-1){haveChecked.push(p);traverse.bind(this)(p.id);}}}.bind(this);traverse(entityId);return _lodash2.default.uniq(results);}exports.default=getIncomingEntitiesAll;/***/},/* 10 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(4);var _lodash2=_interopRequireDefault(_lodash);var _getEntityById=__webpack_require__(6);var _getEntityById2=_interopRequireDefault(_getEntityById);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getOutgoingEntities(entityId,relationshipTypes,data){var fnName='getOutgoingEntities';var results=_lodash2.default.uniq(_lodash2.default.compact(_lodash2.default.map(data.relationships,function(e){if(relationshipTypes.indexOf(e.type,data)>-1&&e.sourceId==entityId)return(0,_getEntityById2.default)(e.targetId,data.entities);},this)));return results;}exports.default=getOutgoingEntities;/***/},/* 11 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(4);var _lodash2=_interopRequireDefault(_lodash);var _getOutgoingEntities=__webpack_require__(10);var _getOutgoingEntities2=_interopRequireDefault(_getOutgoingEntities);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getOutgoingEntitiesAll(entityId,relationshipTypes,data){var fnName='getOutgoingEntitiesAll';if(!data){console.error(fnName,'data not provided.');};var results=[];var haveChecked=[];var traverse=function traverse(itemId){var ps=(0,_getOutgoingEntities2.default)(itemId,relationshipTypes,data);results=results.concat(ps);for(var i=0;i<ps.length;i++){var p=ps[i];if(haveChecked.indexOf(p)===-1){haveChecked.push(p);traverse.bind(this)(p.id);}}}.bind(this);traverse(entityId);return _lodash2.default.uniq(results);}exports.default=getOutgoingEntitiesAll;/***/},/* 12 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(4);var _lodash2=_interopRequireDefault(_lodash);var _getIncomingEntitiesAll=__webpack_require__(9);var _getIncomingEntitiesAll2=_interopRequireDefault(_getIncomingEntitiesAll);var _getIncomingEntities=__webpack_require__(8);var _getIncomingEntities2=_interopRequireDefault(_getIncomingEntities);var _getOutgoingEntitiesAll=__webpack_require__(11);var _getOutgoingEntitiesAll2=_interopRequireDefault(_getOutgoingEntitiesAll);var _getOutgoingEntities=__webpack_require__(10);var _getOutgoingEntities2=_interopRequireDefault(_getOutgoingEntities);var _getEdgeSet=__webpack_require__(7);var _getEdgeSet2=_interopRequireDefault(_getEdgeSet);var _getEntityById=__webpack_require__(6);var _getEntityById2=_interopRequireDefault(_getEntityById);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getPathway(entityId,relationshipTypes,algorithmName,data){var nodes=[];if(!relationshipTypes||relationshipTypes.length===0){console.error('getPathway: relationshipTypes[] cannot be null');}if(algorithmName==='INCOMING_ALL'){nodes=(0,_getIncomingEntitiesAll2.default)(entityId,relationshipTypes,data);}else if(algorithmName==='INCOMING'){nodes=(0,_getIncomingEntities2.default)(entityId,relationshipTypes,data);}else if(algorithmName==='OUTGOING_ALL'){nodes=(0,_getOutgoingEntitiesAll2.default)(entityId,relationshipTypes,data);}else if(algorithmName==='OUTGOING'){nodes=(0,_getOutgoingEntities2.default)(entityId,relationshipTypes,data);// console.log(nodes);
	}else if(algorithmName==='INCOMING-OUTGOING'){var nodesIncoming=(0,_getIncomingEntities2.default)(entityId,relationshipTypes,data);var nodesOutgoing=(0,_getOutgoingEntities2.default)(entityId,relationshipTypes,data);nodes=nodesIncoming.concat(nodesOutgoing);}else{console.error('algorithmName',algorithmName,'not recognized');}nodes=(nodes||[]).concat((0,_getEntityById2.default)(entityId,data.entities));var edges=(0,_getEdgeSet2.default)(_lodash2.default.map(nodes,'id'),relationshipTypes,data);return{nodes:nodes,edges:edges};}exports.default=getPathway;/***/},/* 13 *//***/function(module,exports){'use strict';Object.defineProperty(exports,"__esModule",{value:true});/** rankDAG: constructs the ranking of each node in the given Directed Acyclic Graph
		*/function rankDAG(dag,iterateeFn){var maxIterations=arguments.length<=2||arguments[2]===undefined?10:arguments[2];if(!dag){console.error('DAG of {nodes: []} must be given');}var nodes=dag.nodes;var findDepthTraverse=function findDepthTraverse(arg,iterateeFn,iterations){iterations++;var quantity=iterateeFn(arg);if(quantity.length==0){return 0;}else if(iterations>maxIterations){console.warn('There may be a cycle:',arg.name);return 0;}else{var maxDepth=0;for(var i=quantity.length;i--;){maxDepth=Math.max(maxDepth,findDepthTraverse(quantity[i],iterateeFn,iterations));}return maxDepth+1;}};var levels={};for(var j=0;j<nodes.length;j++){var iterations=0;var depth=findDepthTraverse(nodes[j],iterateeFn,iterations);levels[depth]=levels[depth]||[];levels[depth].push(nodes[j]);}return levels;}exports.default=rankDAG;/***/}/******/]);
