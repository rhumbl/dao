...
/***/ function(module, exports) {
	...
	/******/return __webpack_require__(0);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){__webpack_require__(1);module.exports=__webpack_require__(2);/***/},/* 1 *//***/function(module,exports,__webpack_require__){'use strict';/* requires and exposes the separate components of the app */module.exports=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"./dist/dao.js\"");e.code='MODULE_NOT_FOUND';throw e;}());/***/},/* 2 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global){'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.rankDAG=exports.getPathway=exports.getEdgeSet=exports.getOutgoingEntitiesAll=exports.getOutgoingEntities=exports.getIncomingEntitiesAll=exports.getIncomingEntities=exports.getEntityById=undefined;var _lodash=__webpack_require__(3);var _lodash2=_interopRequireDefault(_lodash);var _getEntityById=__webpack_require__(5);var _getEntityById2=_interopRequireDefault(_getEntityById);var _getEdgeSet=__webpack_require__(6);var _getEdgeSet2=_interopRequireDefault(_getEdgeSet);var _getIncomingEntities=__webpack_require__(7);var _getIncomingEntities2=_interopRequireDefault(_getIncomingEntities);var _getIncomingEntitiesAll=__webpack_require__(8);var _getIncomingEntitiesAll2=_interopRequireDefault(_getIncomingEntitiesAll);var _getOutgoingEntities=__webpack_require__(9);var _getOutgoingEntities2=_interopRequireDefault(_getOutgoingEntities);var _getOutgoingEntitiesAll=__webpack_require__(10);var _getOutgoingEntitiesAll2=_interopRequireDefault(_getOutgoingEntitiesAll);var _getPathway=__webpack_require__(11);var _getPathway2=_interopRequireDefault(_getPathway);var _rankDAG=__webpack_require__(12);var _rankDAG2=_interopRequireDefault(_rankDAG);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var dao=window.dao||{};window.dao=dao;global.dao=dao;exports.getEntityById=_getEntityById2.default;exports.getIncomingEntities=_getIncomingEntities2.default;exports.getIncomingEntitiesAll=_getIncomingEntitiesAll2.default;exports.getOutgoingEntities=_getOutgoingEntities2.default;exports.getOutgoingEntitiesAll=_getOutgoingEntitiesAll2.default;exports.getEdgeSet=_getEdgeSet2.default;exports.getPathway=_getPathway2.default;exports.rankDAG=_rankDAG2.default;/* WEBPACK VAR INJECTION */}).call(exports,function(){return this;}());/***/},/* 3 *//***/function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module,global){/**
		 * @license
	...
	root._=_;}}).call(this);/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(4)(module),function(){return this;}());/***/},/* 4 *//***/function(module,exports){module.exports=function(module){if(!module.webpackPolyfill){module.deprecate=function(){};module.paths=[];// module.parent = undefined by default
	module.children=[];module.webpackPolyfill=1;}return module;};/***/},/* 5 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getEntityById(entityId,entities){var fnName='getEntityById';var result=_lodash2.default.find(entities,{id:entityId});return result;}exports.default=getEntityById;/***/},/* 6 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/** getEdgeSet: returns the edges that are between the given set of nodes
	...
	var matchesDirection1=entityIds.indexOf(r.targetId)>-1&&entityIds.indexOf(r.sourceId)>-1;var matchesDirection2=entityIds.indexOf(r.sourceId)>-1&&entityIds.indexOf(r.targetId)>-1;return relationshipTypes.indexOf(r.type)>-1&&(matchesDirection1||matchesDirection2);});}exports.default=getEdgeSet;/***/},/* 7 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var _lodash2=_interopRequireDefault(_lodash);var _getEntityById=__webpack_require__(5);var _getEntityById2=_interopRequireDefault(_getEntityById);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getIncomingEntities(entityId,relationshipTypes,data){var fnName='getIncomingEntities';var results=_lodash2.default.uniq(_lodash2.default.compact(_lodash2.default.map(data.relationships,function(r){if(relationshipTypes.indexOf(r.type)>-1&&r.targetId===entityId){return(0,_getEntityById2.default)(r.sourceId,data.entities);}})));return results;}exports.default=getIncomingEntities;/***/},/* 8 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var _lodash2=_interopRequireDefault(_lodash);var _getIncomingEntities=__webpack_require__(7);var _getIncomingEntities2=_interopRequireDefault(_getIncomingEntities);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getIncomingEntitiesAll(entityId,relationshipTypes,data){var fnName='getIncomingEntitiesAll';if(!data){console.error(fnName,'data not provided.');};var results=[];var haveChecked=[];var traverse=function traverse(itemId){var ps=(0,_getIncomingEntities2.default)(itemId,relationshipTypes,data);results=results.concat(ps);for(var i=0;i<ps.length;i++){var p=ps[i];if(haveChecked.indexOf(p)===-1){haveChecked.push(p);traverse.bind(this)(p.id);}}}.bind(this);traverse(entityId);return _lodash2.default.uniq(results);}exports.default=getIncomingEntitiesAll;/***/},/* 9 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var _lodash2=_interopRequireDefault(_lodash);var _getEntityById=__webpack_require__(5);var _getEntityById2=_interopRequireDefault(_getEntityById);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getOutgoingEntities(entityId,relationshipTypes,data){var fnName='getOutgoingEntities';var results=_lodash2.default.uniq(_lodash2.default.compact(_lodash2.default.map(data.relationships,function(e){if(relationshipTypes.indexOf(e.type,data)>-1&&e.sourceId==entityId)return(0,_getEntityById2.default)(e.targetId,data.entities);},this)));return results;}exports.default=getOutgoingEntities;/***/},/* 10 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var _lodash2=_interopRequireDefault(_lodash);var _getOutgoingEntities=__webpack_require__(9);var _getOutgoingEntities2=_interopRequireDefault(_getOutgoingEntities);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function getOutgoingEntitiesAll(entityId,relationshipTypes,data){var fnName='getOutgoingEntitiesAll';if(!data){console.error(fnName,'data not provided.');};var results=[];var haveChecked=[];var traverse=function traverse(itemId){var ps=(0,_getOutgoingEntities2.default)(itemId,relationshipTypes,data);results=results.concat(ps);for(var i=0;i<ps.length;i++){var p=ps[i];if(haveChecked.indexOf(p)===-1){haveChecked.push(p);traverse.bind(this)(p.id);}}}.bind(this);traverse(entityId);return _lodash2.default.uniq(results);}exports.default=getOutgoingEntitiesAll;/***/},/* 11 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(3);var _lodash2=_interopRequireDefault(_lodash);var _getIncomingEntitiesAll=__webpack_require__(8);var _getIncomingEntitiesAll2=_interopRequireDefault(_getIncomingEntitiesAll);var _getIncomingEntities=__webpack_require__(7);var _getIncomingEntities2=_interopRequireDefault(_getIncomingEntities);var _getOutgoingEntitiesAll=__webpack_require__(10);var _getOutgoingEntitiesAll2=_interopRequireDefault(_getOutgoingEntitiesAll);var _getOutgoingEntities=__webpack_require__(9);var _getOutgoingEntities2=_interopRequireDefault(_getOutgoingEntities);var _getEdgeSet=__webpack_require__(6);var _getEdgeSet2=_interopRequireDefault(_getEdgeSet);var _getEntityById=__webpack_require__(5);var _getEntityById2=_interopRequireDefault(_getEntityById);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _toConsumableArray(arr){if(Array.isArray(arr)){for(var i=0,arr2=Array(arr.length);i<arr.length;i++){arr2[i]=arr[i];}return arr2;}else{return Array.from(arr);}}function getPathway(entityIdOrIds,relationshipTypes,algorithmName,data){var nodes=[];var edges=[];if(!relationshipTypes||relationshipTypes.length===0){console.error('getPathway: relationshipTypes[] cannot be null');}var entityIds=[];if(typeof entityIdOrIds==='string'){entityIds.push(entityIdOrIds);}else{entityIds=entityIdOrIds;}var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=entityIds[Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var entityId=_step.value;var pathwayNodes=void 0;if(algorithmName==='INCOMING_ALL'){pathwayNodes=(0,_getIncomingEntitiesAll2.default)(entityId,relationshipTypes,data);}else if(algorithmName==='INCOMING'){pathwayNodes=(0,_getIncomingEntities2.default)(entityId,relationshipTypes,data);console.log(pathwayNodes);}else if(algorithmName==='OUTGOING_ALL'){pathwayNodes=(0,_getOutgoingEntitiesAll2.default)(entityId,relationshipTypes,data);}else if(algorithmName==='OUTGOING'){pathwayNodes=(0,_getOutgoingEntities2.default)(entityId,relationshipTypes,data);// console.log(nodes);
	}else if(algorithmName==='INCOMING-OUTGOING'){var nodesIncoming=(0,_getIncomingEntities2.default)(entityId,relationshipTypes,data);var nodesOutgoing=(0,_getOutgoingEntities2.default)(entityId,relationshipTypes,data);pathwayNodes=nodesIncoming.concat(nodesOutgoing);}else{console.error('algorithmName',algorithmName,'not recognized');}nodes=[].concat(_toConsumableArray(nodes),_toConsumableArray(pathwayNodes),[(0,_getEntityById2.default)(entityId,data.entities)]);console.log('nodes so far of',entityId,nodes);edges=edges.concat((0,_getEdgeSet2.default)(_lodash2.default.map(nodes,'id'),relationshipTypes,data));}}catch(err){_didIteratorError=true;_iteratorError=err;}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}}finally{if(_didIteratorError){throw _iteratorError;}}}nodes=_lodash2.default.uniqBy(nodes,'id');edges=_lodash2.default.uniqBy(edges,'id');return{nodes:nodes,edges:edges};}exports.default=getPathway;/***/},/* 12 *//***/function(module,exports){'use strict';Object.defineProperty(exports,"__esModule",{value:true});/** rankDAG: constructs the ranking of each node in the given Directed Acyclic Graph
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.rankDAG = exports.getPathway = exports.getEdgeSet = exports.getOutgoingEntitiesAll = exports.getOutgoingEntities = exports.getIncomingEntitiesAll = exports.getIncomingEntities = exports.getEntityById = undefined;

	var _lodash = __webpack_require__(4);

	var _lodash2 = _interopRequireDefault(_lodash);

	var _getEntityById = __webpack_require__(6);

	var _getEntityById2 = _interopRequireDefault(_getEntityById);

	var _getEdgeSet = __webpack_require__(7);

	var _getEdgeSet2 = _interopRequireDefault(_getEdgeSet);

	var _getIncomingEntities = __webpack_require__(8);

	var _getIncomingEntities2 = _interopRequireDefault(_getIncomingEntities);

	var _getIncomingEntitiesAll = __webpack_require__(9);

	var _getIncomingEntitiesAll2 = _interopRequireDefault(_getIncomingEntitiesAll);

	var _getOutgoingEntities = __webpack_require__(10);

	var _getOutgoingEntities2 = _interopRequireDefault(_getOutgoingEntities);

	var _getOutgoingEntitiesAll = __webpack_require__(11);

	var _getOutgoingEntitiesAll2 = _interopRequireDefault(_getOutgoingEntitiesAll);

	var _getPathway = __webpack_require__(12);

	var _getPathway2 = _interopRequireDefault(_getPathway);

	var _rankDAG = __webpack_require__(13);

	var _rankDAG2 = _interopRequireDefault(_rankDAG);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.getEntityById = _getEntityById2.default;
	exports.getIncomingEntities = _getIncomingEntities2.default;
	exports.getIncomingEntitiesAll = _getIncomingEntitiesAll2.default;
	exports.getOutgoingEntities = _getOutgoingEntities2.default;
	exports.getOutgoingEntitiesAll = _getOutgoingEntitiesAll2.default;
	exports.getEdgeSet = _getEdgeSet2.default;
	exports.getPathway = _getPathway2.default;
	exports.rankDAG = _rankDAG2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getEntityById(entityId, entities) {
	  ...
	  var result = _lodash2.default.find(entities, { id: entityId });
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	function getEdgeSet(entityIds, relationshipTypes, data) {
	  return _lodash2.default.filter(data.relationships, function (r) {
	    // let matches = (r.targetId === entityId || r.sourceId === entityId);
	    // return relationshipTypes.indexOf(r.type) > -1 && matches;

	    var matchesDirection1 = entityIds.indexOf(r.targetId) > -1 && entityIds.indexOf(r.sourceId) > -1;
	    var matchesDirection2 = entityIds.indexOf(r.sourceId) > -1 && entityIds.indexOf(r.targetId) > -1;

	    return relationshipTypes.indexOf(r.type) > -1 && (matchesDirection1 || matchesDirection2);
	  });
	}

	exports.default = getEdgeSet;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getIncomingEntities(entityId, relationshipTypes, data) {
	  var fnName = 'getIncomingEntities';

	  var results = _lodash2.default.uniq(_lodash2.default.compact(_lodash2.default.map(data.relationships, function (r) {
	    if (relationshipTypes.indexOf(r.type) > -1 && r.targetId === entityId) {
	      return (0, _getEntityById2.default)(r.sourceId, data.entities);
	    }
	  })));
	...
	exports.default = getIncomingEntities;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getIncomingEntitiesAll(entityId, relationshipTypes, data) {
	  var fnName = 'getIncomingEntitiesAll';
	  if (!data) {
	  ...
	  var traverse = function traverse(itemId) {
	    var ps = (0, _getIncomingEntities2.default)(itemId, relationshipTypes, data);
	...
	exports.default = getIncomingEntitiesAll;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getOutgoingEntities(entityId, relationshipTypes, data) {
	  ...
	  var results = _lodash2.default.uniq(_lodash2.default.compact(_lodash2.default.map(data.relationships, function (e) {
	    if (relationshipTypes.indexOf(e.type, data) > -1 && e.sourceId == entityId) return (0, _getEntityById2.default)(e.targetId, data.entities);
	  }, this)));

	  return results;
	}

	exports.default = getOutgoingEntities;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getOutgoingEntitiesAll(entityId, relationshipTypes, data) {
	  ...
	  var haveChecked = [];
	  var traverse = function traverse(itemId) {
	    var ps = (0, _getOutgoingEntities2.default)(itemId, relationshipTypes, data);
	    results = results.concat(ps);
	    for (var i = 0; i < ps.length; i++) {
	      var p = ps[i];
	...
	exports.default = getOutgoingEntitiesAll;
	...
	function getPathway(entityIdOrIds, relationshipTypes, algorithmName, data) {
	  ...
	  try {
	    for (var _iterator = entityIds[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      var pathwayNodes = void 0;
	      if (algorithmName === 'INCOMING_ALL') {
	        pathwayNodes = (0, _getIncomingEntitiesAll2.default)(entityId, relationshipTypes, data);
	      } else if (algorithmName === 'INCOMING') {
	        pathwayNodes = (0, _getIncomingEntities2.default)(entityId, relationshipTypes, data);

	        console.log(pathwayNodes);
	      } else if (algorithmName === 'OUTGOING_ALL') {
	        pathwayNodes = (0, _getOutgoingEntitiesAll2.default)(entityId, relationshipTypes, data);
	      } else if (algorithmName === 'OUTGOING') {
	        pathwayNodes = (0, _getOutgoingEntities2.default)(entityId, relationshipTypes, data);
	        // console.log(nodes);
	      } else if (algorithmName === 'INCOMING-OUTGOING') {
	        var nodesIncoming = (0, _getIncomingEntities2.default)(entityId, relationshipTypes, data);
	        var nodesOutgoing = (0, _getOutgoingEntities2.default)(entityId, relationshipTypes, data);
	        pathwayNodes = nodesIncoming.concat(nodesOutgoing);
	      } else {
	        console.error('algorithmName', algorithmName, 'not recognized');
	      }

	      nodes = [].concat(_toConsumableArray(nodes), _toConsumableArray(pathwayNodes), [(0, _getEntityById2.default)(entityId, data.entities)]);
	      console.log('nodes so far of', entityId, nodes);
	      edges = edges.concat((0, _getEdgeSet2.default)(_lodash2.default.map(nodes, 'id'), relationshipTypes, data));
	    }
	  } catch (err) {
	  ...
	  edges = _lodash2.default.uniqBy(edges, 'id');

	  return { nodes: nodes, edges: edges };
	}

	exports.default = getPathway;
...
/***/ function(module, exports) {
	...
	*/
	function rankDAG(dag, iterateeFn) {
	  var maxIterations = arguments.length <= 2 || arguments[2] === undefined ? 10 : arguments[2];
	  ...
	  var findDepthTraverse = function findDepthTraverse(arg, iterateeFn, iterations) {
	    iterations++;
	  ...
	  for (var j = 0; j < nodes.length; j++) {
	    var iterations = 0;
	    var depth = findDepthTraverse(nodes[j], iterateeFn, iterations);
